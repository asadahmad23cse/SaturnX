"""
Password and hash cracking tools for SaturnX MCP server.
...
from saturnx.core.guidance import TOOL_DESCRIPTIONS, target_error
from saturnx.core.security import safe_identifier, shell_quote, validate_target_async
from saturnx.output.filters import TOOL_FILTERS

if TYPE_CHECKING:
    from fastmcp import FastMCP

logger = logging.getLogger("saturnx.tools.cracking")
