...
- [SaturnX examples](#saturnx-examples)
...
SaturnX stores custom scripts under the managed workspace at
...
action = function(host, port)
  ...
  local marker = stdnse.get_script_args(SCRIPT_NAME .. ".marker") or "saturnx-marker"
...
4. If XML parsing fails in SaturnX output, inspect raw stdout via tool output
