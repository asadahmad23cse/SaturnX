...
validate, debug, and run custom Nuclei templates through SaturnX. Use it before
...
SaturnX writes custom templates under `/opt/workspace/nuclei-templates/`.
...
http:
  - method: GET
    ...
    max-redirects: 3
    headers:
      User-Agent: Mozilla/5.0 SaturnX-Nuclei
```
